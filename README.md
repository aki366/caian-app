...
## Caianとは
### 若手リーダーのマネージメントをサポートする実績評価と課題管理が一つになったSNSサービスです。

#### あなたはチームのボス
日々メンバーのタスクを管理したり相談に乗ることも時にはあるでしょう
そんな忙しいあなたは定期的にメンバーの評価をしなくてはいけません。
あなたはメンバーのタスクや成果を覚えていますか？
メンバーの成果を記録する作業に疲れていませんか？
フィードバックに不満を抱いているメンバーはいませんか？

もっとメンバーの日頃の成果を評価したい、マネージメントに集中したい。
そんな思いにCaianは答えます。
あなたやメンバーの努力は努力せずに評価されます。

#### あなたはチームの一員
日々目の前のタスクや小さな問題に気づいては改善を繰り返しています。
そんなあなたは自分のタスクや成果を覚えていますか？
ボスに成果をアピールできていますか？
